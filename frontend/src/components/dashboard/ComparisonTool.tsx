// src/components/dashboard/ComparisonTool.tsx
...
const ComparisonTool = () => {
    ...
    const handleCompare = async () => {
        ...
        const fetchScenario = (location: Location, dateRange: DateRange) => {
            return fetch('http://127.0.0.1:5000/api/weather-stats', {
                ...
                if (!response.ok) throw new Error(`Scenario fetch failed: ${response.statusText}`);
    ...
    return (
        <div className="space-y-6">
            ...
            {error && (
                <div className="flex items-center justify-center gap-3 text-red-600 bg-red-100 p-3 rounded-md">
